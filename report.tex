...
{\centering \resizebox{0.5\textwidth}{!}{\input{report_files/figure-latex/3x3-python-1.tex}} 

}

\caption[Result of online Q-learning using Python for 3x3 case]{Result of online Q-learning using Python for 3x3 case. $\gamma = 0.999$, $\epsilon = 0.99$}\label{fig:3x3-python}
\end{figure}
...
{\centering \subfloat[For $10^6$ iterations\label{fig:10x10-python-1}]{\resizebox{0.5\textwidth}{!}{\input{report_files/figure-latex/10x10-python-1.tex}} }\subfloat[For $10^7$ iterations\label{fig:10x10-python-2}]{\resizebox{0.5\textwidth}{!}{\input{report_files/figure-latex/10x10-python-2.tex}} }

}

\caption[Result of online Q-learning using Python for 10x10 case]{Result of online Q-learning using Python for 10x10 case. $\gamma = 0.99$, $\epsilon = 0.999$}\label{fig:10x10-python}
\end{figure}
...
{\centering \subfloat[Activating $Q_{1}$\label{fig:10x10-python-n-visit-1}]{\resizebox{0.5\textwidth}{!}{\input{report_files/figure-latex/10x10-python-n-visit-1.tex}} }\subfloat[Activating $Q_{2}$\label{fig:10x10-python-n-visit-2}]{\resizebox{0.5\textwidth}{!}{\input{report_files/figure-latex/10x10-python-n-visit-2.tex}} }

}

\caption[Number of visit for the system above]{Number of visit for the system above. $\gamma = 0.99$, $\epsilon = 0.999$}\label{fig:10x10-python-n-visit}
\end{figure}
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-simple-queuing-1-1}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-queuing-1-1.tex}} }\subfloat[Offline Q-learning\label{fig:20x20-simple-queuing-1-2}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-queuing-1-2.tex}} }\subfloat[Value iterations\label{fig:20x20-simple-queuing-1-3}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-queuing-1-3.tex}} }

}

\caption[Result of table \ref{tab:simple-queuing-1} for 20x20 case. \(\gamma = 0.999\), \(\epsilon = 0.999\).]{Result of table \ref{tab:simple-queuing-1} for 20x20 case. \(\gamma = 0.999\), \(\epsilon = 0.999\).}\label{fig:20x20-simple-queuing-1}
\end{figure}
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-simple-queuing-2-1}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-queuing-2-1.tex}} }\subfloat[Offline Q-learning\label{fig:20x20-simple-queuing-2-2}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-queuing-2-2.tex}} }\subfloat[Value iterations\label{fig:20x20-simple-queuing-2-3}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-queuing-2-3.tex}} }

}

\caption[Result of table \ref{tab:simple-queuing-2} for 20x20 case. \(\gamma = 0.999\), \(\epsilon = 0.999\).]{Result of table \ref{tab:simple-queuing-2} for 20x20 case. \(\gamma = 0.999\), \(\epsilon = 0.999\).}\label{fig:20x20-simple-queuing-2}
\end{figure}
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-simple-lb-1-1}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-lb-1-1.tex}} }\subfloat[Offline Q-learning\label{fig:20x20-simple-lb-1-2}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-lb-1-2.tex}} }\subfloat[Value iterations\label{fig:20x20-simple-lb-1-3}]{\resizebox{0.33\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-lb-1-3.tex}} }

}

\caption[Result of table \ref{tab:simple-lb-1} for 20x20 case. \(\gamma = 0.999\), \(\epsilon = 0.999\).]{Result of table \ref{tab:simple-lb-1} for 20x20 case. \(\gamma = 0.999\), \(\epsilon = 0.999\).}\label{fig:20x20-simple-lb-1}
\end{figure}

Intuitively, if two queues has the same parameters, the optimal action will be sending job to the queue that has less jobs, which is the result of value iterations method (the right grid) of figure \ref{fig:20x20-simple-lb-1}. There is also a gray color indicates that at those states, either action \(1\) (sending new job to \(Q_{1}\)) or \(2\) (sending to new job to Q\_\{2\}) leads to the same result, because they have the same number of jobs.
...
{\centering \subfloat[Sending to $Q_{1}$\label{fig:20x20-simple-lb-1-n-visit-1}]{\resizebox{0.5\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-lb-1-n-visit-1.tex}} }\subfloat[Sending to $Q_{2}$\label{fig:20x20-simple-lb-1-n-visit-2}]{\resizebox{0.5\textwidth}{!}{\input{report_files/figure-latex/20x20-simple-lb-1-n-visit-2.tex}} }

}

\caption[Number of visits of online Q-learning on table \ref{tab:simple-lb-1} for 20x20 case.]{Number of visits of online Q-learning on table \ref{tab:simple-lb-1} for 20x20 case.}\label{fig:20x20-simple-lb-1-n-visit}
\end{figure}
