...
{\centering \subfloat[Online Q-learning\label{fig:20x20-simple-scheduling-1-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-scheduling-1-1} }\subfloat[Offline Q-learning\label{fig:20x20-simple-scheduling-1-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-scheduling-1-2} }\subfloat[Value iterations\label{fig:20x20-simple-scheduling-1-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-scheduling-1-3} }
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-simple-scheduling-2-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-scheduling-2-1} }\subfloat[Offline Q-learning\label{fig:20x20-simple-scheduling-2-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-scheduling-2-2} }\subfloat[Value iterations\label{fig:20x20-simple-scheduling-2-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-scheduling-2-3} }
...
{\centering \includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-lb-3-2-11-1} 
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-simple-lb-4-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-lb-4-1} }\subfloat[Offline Q-learning\label{fig:20x20-simple-lb-4-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-lb-4-2} }\subfloat[Value iterations\label{fig:20x20-simple-lb-4-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-simple-lb-4-3} }
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-scheduling-1-2-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-1-2-1} }\subfloat[Offline Q-learning\label{fig:20x20-scheduling-1-2-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-1-2-2} }\subfloat[Value iterations\label{fig:20x20-scheduling-1-2-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-1-2-3} }\newline\subfloat[Online Q-learning\label{fig:20x20-scheduling-1-2-4}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-1-2-4} }\subfloat[Offline Q-learning\label{fig:20x20-scheduling-1-2-5}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-1-2-5} }\subfloat[Value iterations\label{fig:20x20-scheduling-1-2-6}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-1-2-6} }
...
As in \autocite{scheduling-optimal}, the solution of table \ref{tab:mdp-scheduling-1} is serving queue \(1\), which is also the result of the value iteration method on both table \ref{tab:scheduling-1} and table \ref{tab:scheduling-2}.
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-scheduling-3-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-3-1} }\subfloat[Offline Q-learning\label{fig:20x20-scheduling-3-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-3-2} }\subfloat[Value iterations\label{fig:20x20-scheduling-3-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-3-3} }
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-scheduling-4-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-4-1} }\subfloat[Offline Q-learning\label{fig:20x20-scheduling-4-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-4-2} }\subfloat[Value iterations\label{fig:20x20-scheduling-4-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-4-3} }
...
{\centering \subfloat[Activating $Q_{1}$\label{fig:20x20-scheduling-4-n-visit-1}]{\includegraphics[width=0.4\linewidth]{report_files/figure-latex/20x20-scheduling-4-n-visit-1} }\subfloat[Activating $Q_{2}$\label{fig:20x20-scheduling-4-n-visit-2}]{\includegraphics[width=0.4\linewidth]{report_files/figure-latex/20x20-scheduling-4-n-visit-2} }
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-scheduling-5-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-5-1} }\subfloat[Offline Q-learning\label{fig:20x20-scheduling-5-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-5-2} }\subfloat[Value iterations\label{fig:20x20-scheduling-5-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-scheduling-5-3} }
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-lb-1-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-lb-1-1} }\subfloat[Offline Q-learning\label{fig:20x20-lb-1-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-lb-1-2} }\subfloat[Value iterations\label{fig:20x20-lb-1-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-lb-1-3} }

}

\caption{Result of table \ref{tab:lb-1} for 20x20 case. \(\gamma = 0.999\), \(\epsilon = 0.999\).}\label{fig:20x20-lb-1}
\end{figure}
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-lb-2-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-lb-2-1} }\subfloat[Offline Q-learning\label{fig:20x20-lb-2-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-lb-2-2} }\subfloat[Value iterations\label{fig:20x20-lb-2-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-lb-2-3} }

}

\caption{Result of table \ref{tab:lb-1} for 20x20 case. \(\gamma = 0.999\), \(\epsilon = 0.999\).}\label{fig:20x20-lb-2}
\end{figure}
...
\end{minipage} & \begin{minipage}[t]{0.35\columnwidth}\raggedright
Online Q-learning seems to perceive the problem as an empirical MDP problem as we could observe that its results resemble the value iteration result. But we need more analytical inspections to verify this hypothesis.\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright
Same as online Q-learning\strut
\end{minipage} & \begin{minipage}[t]{0.18\columnwidth}\raggedright
