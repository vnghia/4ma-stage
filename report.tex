...
{\centering \subfloat[Online Q-learning\label{fig:20x20-queuing-4-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-queuing-4-1} }\subfloat[Offline Q-learning\label{fig:20x20-queuing-4-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-queuing-4-2} }\subfloat[Value iterations\label{fig:20x20-queuing-4-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-queuing-4-3} }
...
{\centering \subfloat[Activating $Q_{1}$\label{fig:20x20-queuing-4-n-visit-1}]{\includegraphics[width=0.4\linewidth]{report_files/figure-latex/20x20-queuing-4-n-visit-1} }\subfloat[Activating $Q_{2}$\label{fig:20x20-queuing-4-n-visit-2}]{\includegraphics[width=0.4\linewidth]{report_files/figure-latex/20x20-queuing-4-n-visit-2} }
...
{\centering \subfloat[Online Q-learning\label{fig:20x20-queuing-5-1}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-queuing-5-1} }\subfloat[Offline Q-learning\label{fig:20x20-queuing-5-2}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-queuing-5-2} }\subfloat[Value iterations\label{fig:20x20-queuing-5-3}]{\includegraphics[width=0.33\linewidth]{report_files/figure-latex/20x20-queuing-5-3} }
