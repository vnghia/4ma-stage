...
Finally, the bellman equation are obtained by writing \eqref{eq:state-value} and \eqref{eq:action-value} recursively.

\begin{align}
V_{\pi}(s) &= \sum_{a \in \mathcal{A}} \pi(a | s) Q_{\pi}(s, a) \label{eq:bellman-v-1} \\
Q_{\pi}(s, a) &= \sum_{s' \in \mathcal{S}} P(s' | s, a) (R(s' | s, a) + \gamma V_{\pi}(s')) \label{eq:bellman-q-1}
\end{align}
...
\begin{align}
V_{*}(s) &= max_{a} Q_{*}(s, a) = max_{a} \sum_{s' \in \mathcal{S}} P(s' | s, a) (R(s' | s, a) + \gamma V_{*}(s')) \label{eq:bellman-max-v} \\
Q_{*}(s, a) &= \sum_{s' \in \mathcal{S}} P(s' | s, a) (R(s' | s, a) + \gamma V_{\pi}(s')) = \sum_{s' \in \mathcal{S}} P(s' | s, a) (R(s' | s, a) + max_{a} Q_{*}(s, a)) \label{eq:bellman-max-q}
\end{align}
