...
{\centering \subfloat[Sending to $Q_{1}$\label{fig:20x20-simple-lb-1-n-visit-1}]{\includegraphics[width=0.4\linewidth]{report_files/figure-latex/20x20-simple-lb-1-n-visit-1} }\subfloat[Sending to $Q_{2}$\label{fig:20x20-simple-lb-1-n-visit-2}]{\includegraphics[width=0.4\linewidth]{report_files/figure-latex/20x20-simple-lb-1-n-visit-2} }

}

\caption{Number of visits of online Q-learning on table \ref{tab:simple-lb-1} for 20x20 case.}\label{fig:20x20-simple-lb-1-n-visit}
\end{figure}
