...
Where for example if $(1, 1, \dots, 1, 1) \mapsto i$ and $(1, 1, \dots, 1, 2) \mapsto j$, then $\rho_{i, j}$ will be equal to $\xi_{n, 1, 2}$ (the probability that the environment of queue $n$ moves from $m_{1}$ to $m_{2}$).
