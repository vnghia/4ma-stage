...
```{r, 20x20-simple-lb-1-n-visit, fig.show="hold", out.width="40%", fig.align="center", fig.cap="(ref:title-simple-lb-1-n-visit)", fig.subcap=c("Sending to $Q_{1}$", "Sending to $Q_{2}$")}
```
