...
```{r, 20x20-simple-queuing-1, fig.show="hold", out.width="33%", fig.align="center", fig.cap="(ref:title-simple-queuing-1)", fig.subcap=c("Online Q-learning", "Offline Q-learning", "Value iterations")}
```
...
```{r, 20x20-simple-queuing-2, fig.show="hold", out.width="33%", fig.align="center", fig.cap="(ref:title-simple-queuing-2)", fig.subcap=c("Online Q-learning", "Offline Q-learning", "Value iterations")}
```
...
(ref:title-queuing-1) Result of table \@ref(tab:queuing-1) (upper) and \@ref(tab:queuing-2) (lower) for 20x20 case. $\gamma = 0.999$, $\epsilon = 0.999$.

```{r, 20x20-queuing-1-2, fig.show="hold", fig.ncol=3, out.width="33%", fig.align="center", fig.cap="(ref:title-queuing-1)", fig.subcap=c("Online Q-learning", "Offline Q-learning", "Value iterations", "Online Q-learning", "Offline Q-learning", "Value iterations")}
```
...
(ref:title-queuing-3) Result of table \@ref(tab:queuing-3) for 20x20 case. $\gamma = 0.999$, $\epsilon = 0.999$.

```{r, 20x20-queuing-3, fig.show="hold", out.width="33%", fig.align="center", fig.cap="(ref:title-queuing-3)", fig.subcap=c("Online Q-learning", "Offline Q-learning", "Value iterations")}
```
...
(ref:title-queuing-4) Result of table \@ref(tab:queuing-4-mat-1) for 20x20 case. $\gamma = 0.999$, $\epsilon = 0.999$.

```{r, 20x20-queuing-4, fig.show="hold", out.width="33%", fig.align="center", fig.cap="(ref:title-queuing-4)", fig.subcap=c("Online Q-learning", "Offline Q-learning", "Value iterations")}
```
...
(ref:title-queuing-4-n-visit) Number of visits of online Q-learning on table \@ref(tab:queuing-4-mat-1) for 20x20 case. The highest number of visit is $\approx 4 \times 10^{9}$ (at $(0, 0)$) while the lowest one is $\approx 5 \times 10^5$ (at $(20, 20)$).

```{r, 20x20-queuing-4-n-visit, fig.show="hold", out.width="40%", fig.align="center", fig.cap="(ref:title-queuing-4-n-visit)", fig.subcap=c("Activating $Q_{1}$", "Activating $Q_{2}$")}
```
...
(ref:title-queuing-5) Result of table \@ref(tab:queuing-3) with $\alpha = 10^{2}$ for 20x20 case. $\gamma = 0.999$, $\epsilon = 0.999$.

```{r, 20x20-queuing-5, fig.show="hold", out.width="33%", fig.align="center", fig.cap="(ref:title-queuing-5)", fig.subcap=c("Online Q-learning", "Offline Q-learning", "Value iterations")}
```
...
```{r, 20x20-lb-1, fig.show="hold", out.width="33%", fig.align="center", fig.cap="(ref:title-queuing-5)", fig.subcap=c("Online Q-learning", "Offline Q-learning", "Value iterations")}
```
...
```{r, 20x20-lb-2, fig.show="hold", out.width="33%", fig.align="center", fig.cap="(ref:title-queuing-5)", fig.subcap=c("Online Q-learning", "Offline Q-learning", "Value iterations")}
```
